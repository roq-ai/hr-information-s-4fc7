  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Your comprehensive solution to manage employee data, track vacations, and streamline payroll processing."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Your comprehensive solution to manage employee data, track vacations, and streamline payroll processing.`}
            </Text>
            <Box
